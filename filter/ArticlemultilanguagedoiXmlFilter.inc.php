...
/**
 * @file plugins/importexport/multilanguagedoi/filter/ArticlemultilanguagedoiXmlFilter.inc.php
 *
 * Copyright (c) 2014-2020 Simon Fraser University
 * Copyright (c) 2000-2020 John Willinsky
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * @class ArticlemultilanguagedoiXmlFilter
 * @ingroup plugins_importexport_multilanguagedoi
 *
 * @brief Class that converts an Article to a multilanguagedoi XML document.
 */
import('plugins.importexport.multilanguagedoi.filter.IssuemultilanguagedoiXmlFilter');

class ArticlemultilanguagedoiXmlFilter extends IssuemultilanguagedoiXmlFilter
{
    /**
     * Constructor.
     *
    ...
    {
        $this->setDisplayName('multilanguagedoi XML article export');
    ...
    {
        return 'plugins.importexport.multilanguagedoi.filter.ArticlemultilanguagedoiXmlFilter';
    }
    ...
    /**
     * @copydoc IssuemultilanguagedoiXmlFilter::createJournalNode()
     */
    ...
    public function createJournalArticleNode($doc, $submission)
    {
        ...
        // pages
        // multilanguagedoi requires first_page and last_page of any contiguous range, then any other ranges go in other_pages
        ...
        if (!empty($pages)) {
            ...
            // multilanguagedoi accepts no punctuation in first_page or last_page
