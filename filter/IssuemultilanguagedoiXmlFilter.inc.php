...
/**
 * @file plugins/importexport/multilanguagedoi/filter/IssuemultilanguagedoiXmlFilter.inc.php
 *
 * Copyright (c) 2014-2020 Simon Fraser University
 * Copyright (c) 2000-2020 John Willinsky
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * @class IssuemultilanguagedoiXmlFilter
 * @ingroup plugins_importexport_multilanguagedoi
 *
 * @brief Class that converts an Issue to a multilanguagedoi XML document.
 */
import('lib.pkp.plugins.importexport.native.filter.NativeExportFilter');

class IssuemultilanguagedoiXmlFilter extends NativeExportFilter
{
    /**
     * Constructor.
     *
    ...
    {
        $this->setDisplayName('multilanguagedoi XML issue export');
    ...
    {
        return 'plugins.importexport.multilanguagedoi.filter.IssuemultilanguagedoiXmlFilter';
    }
    ...
    public function createJournalMetadataNode($doc)
    {
        ...
        /* Both ISSNs are permitted for multilanguagedoi, so sending whichever one (or both) */
